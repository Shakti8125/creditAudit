---
name: p3-model-validation-analytics
description: >-
  Use this skill when the user asks to build the Phase 3 model validation analytics components, including metric extraction, policy checking, and early warning detection for ModelAudit AI.
---

# Phase 3: Model Validation Analytics
...
## Verification
Test the implementation with synthetic model validation documents containing known metric values. Ensure extraction accuracy is >= 98%.
